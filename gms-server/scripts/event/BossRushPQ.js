...
function setEventRewards(eim) {
    ...
    itemSet.push(1102033, 1142020, 1102227, 1060132, 1102034, 1132016);
    itemQty.push(1, 1, 1, 1, 1, 1);
    ...
    itemSet.push(1072345, 1082218, 1032049, 1102226, 1132015, 1142021);
    itemQty.push(1, 1, 1, 1, 1, 1);
    eim.setEventRewards(evLevel, itemSet, itemQty);
    ...
    itemSet.push(1040145, 1060127, 1112302, 1102179, 1002046, 1102180);
    itemQty.push(1, 1, 1, 1, 1, 1);
    eim.setEventRewards(evLevel, itemSet, itemQty);
    ...
    itemSet.push(1122041, 1132014, 1072346, 1102178, 1040147, 1082246);
    itemQty.push(1, 1, 1, 1, 1, 1);
    eim.setEventRewards(evLevel, itemSet, itemQty);
    ...
    itemSet.push(1102176, 1112301, 1040146, 1060128, 1041046, 1102177);
    itemQty.push(1, 1, 1, 1, 1, 1);
    eim.setEventRewards(evLevel, itemSet, itemQty);
    ...
    itemSet.push(1001035, 1040036, 1032047, 1072261, 1002562, 1082262);
    itemQty.push(1, 1, 1, 1, 1, 1);
    eim.setEventRewards(evLevel, itemSet, itemQty);
}
...
function giveRandomEventReward(eim, player) {
    eim.giveBossEventReward(player, 1);
}
